...
public static class PacketExecutionServer
{
    ...
    public static Action<PacketBase> GetUserHighScore_Command = packBase => ServerLogic.instance.Server_GetUserHighScore_Command(packBase.connectionID, packBase.stringInfo[0]);
